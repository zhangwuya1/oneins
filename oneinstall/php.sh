...
Ln_PHP_Bin()
{
    ...
    yum install  freetype-devel libjpeg-turbo-devel libpng-devel gd-devel libcurl-devel libxslt-devel libmcrypt libmcrypt-devel mhash mhash-devel mcrypt -y >/dev/null 2>&1
